...
import 'package:mood_map/features/mood_map/today/widgets/header_clipper.dart';
...
class MoodHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final gradient2 = LinearGradient(
      ...
      colors: isDark ? [MoodColors.primaryDark, MoodColors.primaryDarkHover] : [MoodColors.primaryNormal, MoodColors.primaryLightHover],
    );

    return Stack(
      children: [
        ClipPath(clipper: HeaderClipper(), child: Container(height: 300, decoration: BoxDecoration(gradient: gradient1))),
        ClipPath(clipper: HeaderClipperTow(), child: Container(height: 300, decoration: BoxDecoration(gradient: gradient2))),
        const HeaderLogo(),
        Positioned(
          top: 130,
          left: 0,
            ...
            children: [
              ...
              Text(
                ...
                style: MoodTextStyles.normal3.copyWith(
                  ...
                  color: isDark ? MoodColors.awfulNormal : MoodColors.badDarkActive,
                  fontFamily: lang == 'ar' ? 'Zain' : 'Poppins',
                ),
              ),
            ],
