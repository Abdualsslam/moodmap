...
class MoodTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      maxLength: 100,
      maxLines: 4,
      style: TextStyle(fontFamily: lang == 'ar' ? 'Zain' : 'Poppins', fontSize: 18, color: isDark ? Colors.white : Colors.black87),
      decoration: InputDecoration(
        hintText: AppLocalizations.of(context)!.moodPlaceholder,
        hintStyle: MoodTextStyles.normal3.copyWith(
          fontSize: 18,
          height: 1.5,
          color: isDark ? MoodColors.tSecondaryDark : MoodColors.tSecondaryNormal,
        ...
        border: OutlineInputBorder(
          ...
          borderSide: BorderSide(color: isDark ? Colors.white24 : MoodColors.primaryNormal),
        ),
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide(color: isDark ? MoodColors.primaryDark : MoodColors.primaryNormal, width: 2),
        ),
        counterStyle: TextStyle(color: isDark ? Colors.white54 : Colors.black45, fontFamily: lang == 'ar' ? 'Zain' : 'Poppins'),
      ),
