...
import 'package:mood_map/features/mood_map/today/widgets/mood_btn.dart';
import 'package:mood_map/features/mood_map/today/widgets/mood_header.dart';
import 'package:mood_map/features/mood_map/today/widgets/mood_emojis.dart';
import 'package:mood_map/features/mood_map/today/widgets/mood_text_field.dart';
                ...
                children: [
                  Text(
                    ...
                    style: MoodTextStyles.bold4.copyWith(
                      ...
                      fontSize: 24,
                      height: 1.46,
                      color: isDark ? Colors.white : Colors.black, // لون ديناميكي
                      fontFamily: Localizations.localeOf(context).languageCode == 'ar' ? 'Zain' : 'Poppins',
                    ),
                  ),
                  const SizedBox(height: 16),
                  MoodEmojis(moodList: moodList, selected: provider.selectedMood, onSelect: provider.setMood),
