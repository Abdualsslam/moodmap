        ...
        child: Column(
          ...
          children: [
              ...
              children:
                  moods.map((m) {
                    ...
                    return GestureDetector(
                      onTap: () => setState(() => selectedMood = m['type'] as MoodType),
                      child: CircleAvatar(
                        backgroundColor: isSelected ? (isDark ? Colors.white12 : Colors.black12) : Colors.transparent,
                        radius: 24,
                        child: Image.asset(m['icon'] as String, width: 34, height: 34),
                      ),
                    );
            ...
            TextField(
              ...
              style: Theme.of(context).textTheme.bodyLarge?.copyWith(fontSize: 18, height: 1.4),
            ),
            const SizedBox(height: 18),
            Row(
              children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: Text(
                      AppLocalizations.of(context)!.save,
                      style: TextStyle(fontWeight: FontWeight.bold, color: isDark ? Colors.white : Colors.black, fontSize: 19),
                    ),
                  ),
                ),
              ],
