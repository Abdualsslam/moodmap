...
class IconFilterWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final badgeColor = selectedFilter != null ? (isDark ? MoodColors.primaryDark : MoodColors.primaryNormal) : Colors.transparent;
    ...
    return Stack(
      ...
      children: [
        IconButton(
          onPressed: onFilterTap,
          icon: Icon(Icons.filter_alt_outlined, color: isDark ? Colors.white70 : Colors.grey[700], size: 30),
          tooltip:
              selectedFilter != null
                  ? AppLocalizations.of(context)!.filterTooltipActive
                  : AppLocalizations.of(context)!.filterTooltipInactive,
