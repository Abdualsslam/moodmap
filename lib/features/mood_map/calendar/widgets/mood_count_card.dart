...
import 'package:mood_map/features/data/models/chart_model.dart';
import 'package:mood_map/features/mood_map/calendar/widgets/emojis_bar_widget.dart';
...
class MoodCountCard extends StatefulWidget {
  const MoodCountCard({super.key, this.month, this.year, this.weekStart, this.weekEnd, this.filter});
  ...
  Future<void> _shareCard() async {
    try {
      ...
      if (image != null) {
        ...
        await Share.shareXFiles([XFile(file.path)], text: AppLocalizations.of(context)!.shareMoodStats);
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(AppLocalizations.of(context)!.shareError + e.toString())));
      }
    }
  }
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Image.asset(
                      ...
                      width: 24,
                      height: 24,
                      color: settings.isDarkMode ? MoodColors.awfulDarkActive : MoodColors.awfulNormalActive,
                    ),
                  ),
                ],
              ),
                    ...
                    SizedBox(
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          Positioned(
                            top: 40,
                            child: Text('$total', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 33, color: textColor)),
                          ),
