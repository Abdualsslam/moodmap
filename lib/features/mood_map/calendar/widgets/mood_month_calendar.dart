      ...
      child: Column(
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              IconButton(onPressed: _prevMonth, icon: Icon(Icons.chevron_left, color: isDark ? colorScheme.primary : MoodColors.badDarker)),
              Text(
                '${monthName(_displayedMonth, context)} $_displayedYear',
              ...
              IconButton(
                ...
                icon: Icon(Icons.chevron_right, color: isDark ? colorScheme.primary : MoodColors.badDarker),
              ),
            ],
          ),
          const SizedBox(height: 16),
                ...
                child: Container(
                  ...
                  child: Text(
                    ...
                    style: textTheme.bodyLarge?.copyWith(
                      ...
                      color:
                          isFuture
                              ? (isDark ? Colors.grey[600] : MoodColors.awfulNormalActive)
                              : (isDark ? MoodColors.primaryNormalHover : MoodColors.primaryDarker),
                    ),
                  ),
                ),
              );
