...
import 'package:mood_map/features/mood_map/calendar/widgets/icon_filter_widget.dart';
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: TextButton(
              style: TextButton.styleFrom(
                backgroundColor: isWeekView ? (isDark ? MoodColors.primaryDarkActive : MoodColors.primaryNormal) : cardColor,
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
              ),
              onPressed: onWeekTap,
              child: Text(
                ...
                style: MoodTextStyles.normal1.copyWith(
                  ...
                  color:
                      isWeekView
                          ? (isDark ? MoodColors.primaryNormal : MoodColors.primaryDarker)
                          : (isDark ? MoodColors.awfulDark : MoodColors.awfulNormalHover),
