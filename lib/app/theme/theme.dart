...
class MoodTheme {
  static ThemeData lightTheme(String lang) {
    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        displayLarge: MoodTextStyles.bold4.copyWith(fontFamily: isArabic ? 'Zain' : 'Poppins'),
        displayMedium: MoodTextStyles.bold3.copyWith(fontFamily: isArabic ? 'Zain' : 'Poppins'),
        bodyLarge: MoodTextStyles.normal3.copyWith(fontFamily: isArabic ? 'Zain' : 'Poppins'),
        bodyMedium: MoodTextStyles.normal1.copyWith(fontFamily: isArabic ? 'Zain' : 'Poppins'),
        bodySmall: MoodTextStyles.smallText.copyWith(fontFamily: isArabic ? 'Zain' : 'Poppins'),
      ),
